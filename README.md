...
<h1 align="center">Markdown Live Previewer</h1>

<p align="center">
  Write markdown, see it render in real time. Export HTML or download your document.
</p>

<p align="center">
  <a href="https://github.com/parithosh-varma/markdown-live-previewer">
    <img src="https://img.shields.io/badge/📂_Source-GitHub-181717?style=flat-square&logo=github&logoColor=white" alt="GitHub Repo" />
  </a>
  <a href="https://markdown-live-previewer-431.netlify.app">
...
**This is the live demo of the tool:** https://markdown-live-previewer-431.netlify.app

---

## Core Features

- **Live Rendering** — Preview updates instantly as you type
- **GitHub-Flavored Markdown** — Headings, lists, tables, task lists, blockquotes, strikethrough
- **Syntax Highlighted Code Blocks** — Fenced code rendered with a clean mono font
- **Sanitized Output** — HTML is purified with DOMPurify before display
- **Copy HTML** — Grab the rendered markup for your blog or CMS
- **Download** — Export as `.md` or a standalone `.html` document
- **Word & Char Counts** — Live stats for your document
...
git clone https://github.com/parithosh-varma/markdown-live-previewer.git
...
│   └── index.css           # Tailwind + design tokens + preview styles
